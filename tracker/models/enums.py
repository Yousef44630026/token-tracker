...
class DataQualityFlag(str, Enum):
    ...
    DUPLICATE_FINAL_UNVERIFIED = "duplicate_final_unverified"
    ...
    PROVIDER_INPUT_TRUNCATED = "provider_input_truncated"
    PROVIDER_USAGE_UNVERIFIED = "provider_usage_unverified"
