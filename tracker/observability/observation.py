...
from tracker.analytics.observation_contract import STATUS_VALUES
...
class Observation:
    ...
    def __post_init__(self) -> None:
        ...
        if self.authoritative is not None and not isinstance(self.authoritative, bool):
            raise ValueError("authoritative must be a boolean when provided")
