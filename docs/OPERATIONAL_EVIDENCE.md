...
| Collector supervision | Crash recovery, alerting, periodic monitor, and stale-health dead-man passed; reboot/resume pending | Auto-start, restart-on-failure, downtime alert, and stale-monitor detection verified | `docs/evidence/COLLECTOR_SUPERVISION_20260714.md` |
